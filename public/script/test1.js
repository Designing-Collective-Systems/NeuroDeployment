...
document.addEventListener("touchend", e => {
    ...
    const measureResults = { 
        ...
        totalTime: totalTime !== undefined ? String(totalTime) : "0",
        averageDragSpeed: averageDragSpeed !== undefined ? String(averageDragSpeed) : "0",
        lastSpeed: lastSpeed !== undefined ? String(lastSpeed) : "0",
        peakSpeed: peakSpeed !== undefined ? String(peakSpeed) : "0",
        timeToPeakSpeed: timeToPeakSpeed !== undefined ? String(timeToPeakSpeed) : "0",
        lastAcceleration: lastAcceleration !== undefined ? String(lastAcceleration) : "0",
        averageAcceleration: averageAcceleration !== undefined ? String(averageAcceleration) : "0",
        tapAreaSize: tapAreaSize !== undefined ? String(tapAreaSize) : "0",
        shortestPathDistance: shortestPathDistance !== undefined ? String(shortestPathDistance) : "0"
    };
